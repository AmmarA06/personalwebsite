...
function App() {
  ...
  return (
    <>
      <MinimalistCursor />
      <div className="min-h-screen px-6 py-12 flex items-center justify-center bg-stone-50 dark:bg-neutral-900 transition-colors duration-300">
          ...
          <main className="space-y-2.5 text-base leading-relaxed dark:text-neutral-300">
            <div className="flex items-start gap-3">
              ...
              <div className="flex items-center gap-2">
                <img src="/Utoronto_coa.svg.png" alt="UofT" className="h-6 w-6 object-contain" />
                <p>
                  comp eng at{' '}
                  <a
            ...
            <div className="flex items-start gap-3">
              <span className="text-neutral-400 mt-0.5">➣</span>
              <div className="flex items-center gap-2">
                <img src="/autoronto.webp" alt="aUToronto" className="h-6 w-6 object-contain" />
                <p>
              ...
              <div>
                ...
                <div className="ml-5 space-y-2">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      <img src="/graycore-cube.svg" alt="Graycore" className="h-6 w-6 object-contain" />
                      <p>
                        SWE Intern at{' '}
                        <a
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-neutral-300 mt-0.5">→</span>
                    <div className="flex items-center gap-2">
                      <img src="/University_of_Waterloo_seal.svg.png" alt="UWaterloo" className="h-6 w-6 object-contain" />
                      <p>
                ...
                <div className="ml-5 space-y-2">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p>
                      a{' '}
                      <a
                        href="https://github.com/AmmarA06/JamHacks"
                        className="hover-underline font-medium"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        focus app that tracks gaze to improve concentration
                      </a>
                      {' '}(interest from{' '}
                      <img src="/snowflake-color.png" alt="Snowflake" className="h-5 w-5 object-contain inline align-text-bottom" />
                      {' '}
                      <a className='hover-underline font-medium' href="https://www.snowflake.com/en/"   target="_blank" 
  rel="noopener noreferrer" >Snowflake</a>)
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-neutral-300 mt-0.5">→</span>
